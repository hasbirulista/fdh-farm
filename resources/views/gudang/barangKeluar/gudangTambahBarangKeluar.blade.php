...
@section('content')
    ...
    <form action="/dashboard/gudang/barang-keluar" method="POST">
        @csrf
            ...
            <div class="form-row">
                <div class="form-group">
                    ...
                    <input type="date" required name="tanggal_barang_keluar" id="tanggal_barang_keluar"
                        value="{{ old('tanggal_barang_keluar') }}">
                </div>
                <div class="form-group">
        ...
        {{-- SECTION 3: TELUR --}}
        <div id="telur-section" class="form-section hidden">
            <h5>🥚 Detail Telur</h5>
            <div class="form-row">
                <div class="form-group">
        ...
        <div id="ayam_apkir-section" class="form-section hidden">
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            jenisBarangSelect.addEventListener('change', function() {
                ...
                if (value === 'telur') {
                    ...
                    // Reset ayam form
                    jumlahAyamInput.value = '';
                    totalAyamInput.value = '';
                } else if (value === 'ayam_apkir') {
                    // Show ayam section
                    ayamApkirSection.classList.remove('hidden');
                    ayamApkirSection.classList.add('visible');
                    ...
                    // Reset telur form
                    jenisTelurInput.value = '';
                    jumlahTelurInput.value = '';
                    hargaKiloInput.value = '';
