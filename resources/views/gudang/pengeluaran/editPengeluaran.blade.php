...
@section('content')
    ...
    <div class="py-3">
        ...
        <form action="{{ route('gudang.updatePengeluaran', $pengeluaran->id) }}" method="POST">
            @csrf
            @method('PUT')
            ...
            {{-- FORM PAKAN --}}
            <div id="formPakan" class="{{ $pengeluaran->jenis_pengeluaran === 'pakan' ? '' : 'd-none' }}">
                <div class="form-section">
                    <div class="form-section-title">
                        <span>🌾</span>
            ...
            {{-- FORM LAINNYA --}}
            <div id="formLainnya" class="{{ $pengeluaran->jenis_pengeluaran === 'lainnya' ? '' : 'd-none' }}">
                <div class="form-section">
                    <div class="form-section-title">
                        <span>📌</span>
            ...
            <div class="form-section">
                ...
                <div class="form-group">
                    ...
                    <textarea name="keterangan" class="form-control" placeholder="Masukkan keterangan atau catatan tambahan...">{{ $pengeluaran->keterangan }}</textarea>
                </div>
            </div>
