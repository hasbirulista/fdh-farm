...
@section('content')
    ...
    <form action="{{ route('egg-grow.storePengeluaran') }}" method="POST">
            ...
            <div class="form-row">
                <div class="form-group">
                    ...
                    <select id="jenis_pengeluaran" name="jenis_pengeluaran" class="form-select" required>
                        ...
                        <option value="telur pecah">🥚 Telur Pecah</option>
        ...
        <div id="formTelurPecah" class="form-section hidden">
        ...
        {{-- SECTION 3: LAINNYA --}}
        <div id="formLainnya" class="form-section hidden">
    ...
    <script>
        ...
        jenisPengeluaran.addEventListener('change', function() {
            if (this.value === 'telur pecah') {
                formTelurPecah.classList.remove('hidden');
                formTelurPecah.classList.add('visible');
                formLainnya.classList.remove('visible');
                formLainnya.classList.add('hidden');

                jenisTelur.required = true;
                beratTotal.required = true;
                hargaKilo.required = true;
                ...
                formTelurPecah.classList.remove('visible');
                formTelurPecah.classList.add('hidden');
                formLainnya.classList.remove('hidden');
                formLainnya.classList.add('visible');

                jenisTelur.required = false;
                beratTotal.required = false;
                hargaKilo.required = false;
                nominalTelur.required = false;
