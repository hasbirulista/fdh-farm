...
@section('content')
    ...
    <div class="py-3">
        ...
        {{-- FORM --}}
        <form action="/dashboard/pakan/distribusi" method="POST" id="form-distribusi">
            @csrf
                    ...
                    <div class="col-12 col-md-6">
                        <div class="form-group">
                            ...
                            <input type="date" required id="tanggal_distribusi" name="tanggal_distribusi" 
                                class="form-control" value="{{ old('tanggal_distribusi') }}">
                        ...
                        <div class="form-group">
                            ...
                            <select id="jenis_pakan" required name="stok_pakan_id" class="form-select">
                                ...
                                @foreach ($data_pakan as $pakan)
                                    <option value="{{ $pakan->id }}" {{ old('stok_pakan_id') == $pakan->id ? 'selected' : '' }}>
                                        {{ $pakan->jenis_pakan }}
                                    </option>
                                @endforeach
                            </select>
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                <input type="number" required id="jumlah_berat_kg" name="jumlah_berat_kg" 
                                    ...
                                    value="{{ old('jumlah_berat_kg') ? old('jumlah_berat_kg') : (isset($data_distribusi) ? $data_distribusi->jumlah_berat / 1000 : '') }}">
            ...
            <div class="button-group">
                <button class="btn-submit" type="submit">💾 Simpan Distribusi</button>
